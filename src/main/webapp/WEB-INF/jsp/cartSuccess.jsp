...
<body>
    ...
    <jsp:include page="commons_cart/header1.jsp" />
    <jsp:include page="commons_cart/mainmenu.jsp" />
	<!--main start-->
	<div class="cartMain">
		<div class="cartThead" style="margin: 50px 0px 50px 50px;">
			...
			<div class="cartJsuan">
				...
				<input type="button" class="jiesuan youxuan" onclick="location.href='http://localhost:8080/cart/cart'" value="去购物车结算"/>
			</div>
		</div>
