...
<body class="easyui-layout">
	...
	<div data-options="region:'north',border:false" style="height:60px; padding:5px; background:#F3F3F3"> 
		<span class="northTitle">易租物品租赁平台后台管理系统</span>
    ...
    <div data-options="region:'west',title:'菜单',split:true" style="width:180px;">
    	<ul id="menu" class="easyui-tree" style="margin-top: 10px;margin-left: 5px;">
         	<li>
         		<span>商品管理</span>
         		<ul>
	         		<li data-options="attributes:{'url':'goods-add'}">新增商品</li>
	         		<li data-options="attributes:{'url':'goods-list'}">查询商品</li>
	         		<li data-options="attributes:{'url':'goods-param-list'}">规格参数</li>
	         	</ul>
         	</li>
         	<li>
         		<span>网站内容管理</span>
         	...
         	<li>
         		<span>索引库管理</span>
         		<ul>
	         		<li data-options="attributes:{'url':'index-goods'}">solr索引库维护</li>
	         	</ul>
         	</li>
         </ul>
    </div>
