...
<body>
		<!-- header -->
		<div class="header">
			<img src="/images/logo.jpg" border="0" /><span>欢迎注册</span></a>
		</div>
    ...
    <ul class="individualUserBg">
        <form id="regForm_mod" name="regForm_mod" method="post"  >
			...
			<span  class="regM" style="margin-left:29px">
				...
				<a href="#" target="_blank"  class="checkTitle">我已阅读并同意<font style="font-size:12px;">《易租物品租赁平台用户注册协议》</font></a>
			</span>
...
<!--mainOver-->
		...
		<div class="footer">
			...
			<p> 
				重庆大学城市科技学院易租物品租赁平台<br />
				Copyright© 易租物品租赁平台 yzrentalplatform.cn 版权所有<br />
			</p>
		</div>
		<!-- /footer -->
