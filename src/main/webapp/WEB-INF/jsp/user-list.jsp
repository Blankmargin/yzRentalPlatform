...
<table class="easyui-datagrid" id="itemList" title="商品列表" /item/list',method:
       data-options="singleSelect:false,collapsible:true,pagination:true,url:''get',pageSize:30,toolbar:toolbar">
    <thead>
        <tr>
